...
class PGObject
{
	...
	*/
	...
	public function getInfoItemObject($fields, $table, $field_id, $value){
		global $database;
		...
		$where = " WHERE ".$field_id."=%d";
		$result = $database->db_query("SELECT ".$colums." FROM ".$table . $where." LIMIT 1", $value);
