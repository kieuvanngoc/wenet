...
class Curl
{
    ...
    public function setCookie($key, $value)
    {
        ...
        $this->setOpt(CURLOPT_COOKIE, implode('; ', array_map($this->key_pot_value($k, $v), array_keys($this->cookies), array_values($this->cookies))));
    }
    function key_pot_value($k, $v) {
        return $k . '=' . $v;
    }
    /**
     * Get cookie.
    ...
    {
        $this->jsonDecoder = $this->jsonDecoder($response);
    }
    public function jsonDecoder($response){
    ...
    {
        $this->xmlDecoder = $this->xmlDecoder($response);
    }
    public function xmlDecoder($response) {
